<%-- 
    Document   : Salesindex
    Created on : Nov 26, 2019, 3:02:44 PM
    Author     : edwin
--%>
  ...
  <link href="css/css/simple-sidebar.css" rel="stylesheet">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href = "addUsers.jsp" class="list-group-item list-group-item-action bg-light" id="">Sell</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid" id="mainArea">
        ...
        <form>
          <table>
            <tr>
              Product:<select><option>Milk</option>
                <option>Cheese</option>
                <option>Yougurt</option></select><br><br>
