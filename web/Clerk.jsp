<%-- 
    Document   : Clerk
    Created on : Nov 26, 2019, 5:35:31 PM
    Author     : edwin
--%>
...
<html>
  ...
  <link href="css/css/simple-sidebar.css" rel="stylesheet">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading">Clerk </div>
      <div class="list-group list-group-flush">
        <a href = "addMilk.php" class="list-group-item list-group-item-action bg-light" id="addMilk.js">Add Milk</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid" id="mainArea">
		...
		function drawChart() {
		  ...
		  var options = {'title':'Milk Assigned per product', 'width':550, 'height':400};
