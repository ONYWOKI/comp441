<%-- 
    Document   : assignProducts
    Created on : Nov 26, 2019, 5:56:15 PM
    Author     : edwin
--%>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid" id="mainArea">
       <form>
         <table>
           <tr>
             Milk=: <input type="text" name="Milk_quantity"><br><br>
             Cheese=: <input type="text" name="Cheese_milk_quantity"><br><br>
             Yougurt=: <input type="text" name="Yougurt_milk_quantity"><br><br>
