<%-- 
    Document   : addProductProduced
    Created on : Nov 26, 2019, 6:03:37 PM
    Author     : edwin
--%>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid" id="mainArea">
       <form>
         <table>
           <tr>
             Milk(@litre): <input type="text" name="milk_quantity"><br><br>
             Cheese(@kg): <input type="text" name="cheese_quantity">
             Yougurt(@packet): <input type="text" name="youghur_quantity">
             </select><br><br>
           </tr>
         </table>
         <button>Add</button>
